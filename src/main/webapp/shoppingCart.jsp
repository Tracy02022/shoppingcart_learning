...
<c:if test="${empty cartForm or empty cartForm.cartLines}">
    ...
    <a href="${pageContext.request.contextPath}/productList.jsp">Show
        Product List</a>
</c:if>

<c:if test="${not empty cartForm and not empty cartForm.cartLines   }">
    <form:form method="POST" modelAttribute="cartForm"
               action="${pageContext.request.contextPath}/shoppingCart.jsp">
        ...
        <a class="navi-item"
           href="${pageContext.request.contextPath}/shoppingCartCustomer.jsp">Enter
            Customer Info</a>
        <a class="navi-item"
           href="${pageContext.request.contextPath}/productList.jsp">Continue
            Buy</a>
    </form:form>
